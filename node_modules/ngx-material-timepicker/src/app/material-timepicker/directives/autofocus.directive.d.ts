...
export declare class AutofocusDirective implements OnChanges, OnDestroy {
    ...
    ngOnChanges(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<AutofocusDirective, [null, { optional: true; }]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<AutofocusDirective, "[timepickerAutofocus]", never, { "isFocusActive": "timepickerAutofocus"; }, {}, never>;
}

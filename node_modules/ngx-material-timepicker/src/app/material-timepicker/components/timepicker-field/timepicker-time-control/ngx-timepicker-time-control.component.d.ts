...
export declare class NgxTimepickerTimeControlComponent implements OnChanges {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NgxTimepickerTimeControlComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NgxTimepickerTimeControlComponent, "ngx-timepicker-time-control", never, { "time": "time"; "min": "min"; "max": "max"; "placeholder": "placeholder"; "timeUnit": "timeUnit"; "disabled": "disabled"; "timeList": "timeList"; "preventTyping": "preventTyping"; }, { "timeChanged": "timeChanged"; }, never, never>;
}

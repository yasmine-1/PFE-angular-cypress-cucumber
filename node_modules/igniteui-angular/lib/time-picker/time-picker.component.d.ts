...
export declare class IgxTimePickerComponent extends PickerBaseDirective implements IgxTimePickerBase, ControlValueAccessor, OnInit, OnDestroy, AfterViewInit, Validator {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<IgxTimePickerComponent, [null, null, { optional: true; }, { optional: true; }, null, null]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxTimePickerComponent, "igx-time-picker", never, { "id": "id"; "displayFormat": "displayFormat"; "inputFormat": "inputFormat"; "mode": "mode"; "minValue": "minValue"; "maxValue": "maxValue"; "spinLoop": "spinLoop"; "formatter": "formatter"; "headerOrientation": "headerOrientation"; "readOnly": "readOnly"; "value": "value"; "resourceStrings": "resourceStrings"; "okButtonLabel": "okButtonLabel"; "cancelButtonLabel": "cancelButtonLabel"; "itemsDelta": "itemsDelta"; }, { "selected": "selected"; "valueChange": "valueChange"; "validationFailed": "validationFailed"; }, ["label", "timePickerActionsDirective", "clearComponents"], ["[igxLabel]", "igx-prefix,[igxPrefix]", "igx-suffix,[igxSuffix]", "igx-hint,[igxHint]"]>;
}
/**
 * @hidden
 */

...
export declare class IgxTreeNodeLinkDirective implements OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<IgxTreeNodeLinkDirective, "[igxTreeNodeLink]", never, { "parentNode": "igxTreeNodeLink"; }, {}, never>;
}
/**
 *
...
export declare class IgxTreeNodeComponent<T> extends ToggleAnimationPlayer implements IgxTreeNode<T>, OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxTreeNodeComponent<any>, "igx-tree-node", never, { "data": "data"; "loading": "loading"; "resourceStrings": "resourceStrings"; "active": "active"; "disabled": "disabled"; "selected": "selected"; "expanded": "expanded"; }, { "selectedChange": "selectedChange"; "expandedChange": "expandedChange"; }, ["linkChildren", "_children", "allChildren"], ["igx-tree-node", "*"]>;
}

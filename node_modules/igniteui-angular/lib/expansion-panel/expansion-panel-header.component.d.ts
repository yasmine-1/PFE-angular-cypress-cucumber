...
export declare class IgxExpansionPanelHeaderComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<IgxExpansionPanelHeaderComponent, "igx-expansion-panel-header", never, { "lv": "lv"; "role": "role"; "iconPosition": "iconPosition"; "disabled": "disabled"; }, { "interaction": "interaction"; }, ["iconTemplate", "customIconRef"], ["igx-expansion-panel-title", "igx-expansion-panel-description", "*", "igx-expansion-panel-icon"]>;
}

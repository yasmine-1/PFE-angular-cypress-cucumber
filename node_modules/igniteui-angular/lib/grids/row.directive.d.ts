...
export declare class IgxRowDirective implements DoCheck, AfterViewInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<IgxRowDirective, "[igxRowBaseComponent]", never, { "data": "data"; "index": "index"; "disabled": "disabled"; "gridID": "gridID"; "selected": "selected"; }, { "addAnimationEnd": "addAnimationEnd"; }, never>;
}

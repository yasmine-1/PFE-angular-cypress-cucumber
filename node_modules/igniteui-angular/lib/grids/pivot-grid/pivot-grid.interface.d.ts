...
*/
export declare const DEFAULT_PIVOT_KEYS: {
    aggregations: string;
    records: string;
    children: string;
    level: string;
...
export interface IPivotDimensionStrategy {
    process(collection: any, dimensions: IPivotDimension[], values: IPivotValue[], pivotKeys?: IPivotKeys): any[];
}
/**
...
*/
export declare type PivotAggregation = (members: any[], data: any[]) => any;
/**
